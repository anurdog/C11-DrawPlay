...
public class Cat {
	...
	private static final int EYE_Y = HEAD_DIMENSION/2; // change eye from 1/2 from top of head to 1/2 to the left
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		g2.drawString("Meeooow", catX, catY+HEAD_DIMENSION+10);	
	}
}
